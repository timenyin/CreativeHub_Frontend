                        ...
                        <div class="card shadow rounded-2 p-0">
                            ...
                            <div class="card-body p-4">
                                <div class="tab-content pt-2" id="course-pills-tabContent">
                                    <!-- Content START -->
                                    <?php include('manage_order/order_all_selling.php') ?>
                                    <!-- Content END -->
                                    <!-- Content active_order START -->
                                    <?php include('manage_order/order_active_selling.php') ?>
                                    <!-- Content END -->

                                    <!-- Content delivered_selling  END -->
                                    <?php include('manage_order/order_delivered_selling.php') ?>
                                    <!-- Content END -->

                                    <!-- Content complete_order START -->
                                    <?php include('manage_order/order_completed_selling.php') ?>
                                    <!-- Content END -->

                                    <!-- Content complete_order START -->
                                    <?php include('manage_order/order_cancelled_selling.php') ?>
                                    <!-- Content END -->
                                </div>
                            </div>
                            <!-- Tab contents END -->
