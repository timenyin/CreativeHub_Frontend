...
<head>
    <title>creativeHub - Selling Guide</title>

    <!-- Meta Tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="author" content="Harmony2k">
    <meta name="description" content="View creativehub - Selling Guide">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <!-- Title -->
                                <h2>How to start selling on <em class="bg-warning px-2">CreativeHub</em></h2>
                            </div>
                            <!-- Title END -->
                            ...
                            <div class="col-12 position-relative">
                                <div class="video-player rounded-3">
                                    <video controls crossorigin="anonymous" playsinline
                                        poster="assets/images/videos/thumbnail.png">
                                        ...
                                        <div class="row g-5">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                                    <div class="d-flex">
                                                        <a class="btn btn-danger-soft btn-round mb-0"><i
                                                        ...
                                                        <div class="ms-2 ms-sm-3 mt-1 mt-sm-0">
                                                            ...
                                                            <audio class="audioPlayer" controls>
                                                                <source src="assets/images/videos/search.mp3"
                                                                    type="audio/mpeg">
                                                            </audio>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2 ms-sm-3 mt-1 mt-sm-0">
                                                            ...
                                                            <p class="mb-2 mb-sm-0 small audio_count"></p>
                                                            <audio class="audioPlayer" controls>
                                                                <source src="assets/images/videos/filters.mp3"
                                                                    type="audio/mpeg">
                                                            </audio>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2 ms-sm-3 mt-1 mt-sm-0">
                                                            ...
                                                            <audio class="audioPlayer" controls>
                                                                <source
                                                                    src="assets/images/videos/Categories and Subcategories.mp3"
                                                                    type="audio/mpeg">
                                                            </audio>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2 ms-sm-3 mt-1 mt-sm-0">
                                                            ...
                                                            <div class="embed-responsive embed-responsive-16by9 my-3"
                                                                ...
                                                                <video class="videoPlayer embed-responsive-item"
                                                                    controls
                                                                    poster="assets/images/videos/payment_services.png">
                                                                    <source
                                                                        src="assets/images/videos/payment_services.mp4"
                                                                        type="video/mp4">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2 ms-sm-3 mt-1 mt-sm-0">
                                                            ...
                                                            <div class="embed-responsive embed-responsive-16by9 my-3"
                                                                style="max-width: 800px;">
                                                                <video class="videoPlayer embed-responsive-item"
                                                                    controls poster="assets/images/videos/buy&sell.png">
                                                                    <source src="assets/images/videos/Sell & Buy.mp4"
                                                                        type="video/mp4">
                                                                    <!-- Add additional source tags for other video formats if needed -->
                                                                </video>
                                                            </div>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2 ms-sm-3 mt-1 mt-sm-0">
                                                            ...
                                                            <div class="embed-responsive embed-responsive-16by9 my-3"
                                                                ...
                                                                <video class="videoPlayer embed-responsive-item"
                                                                    controls
                                                                    poster="assets/images/videos/CreatingProposals.png">
                                                                    <source
                                                                        src="assets/images/videos/Creating_aproposals.mp4"
                                                                        type="video/mp4">
                                                                    <!-- Add additional source tags for other video formats if needed -->
                                                                </video>
                                                            </div>
                        ...
                        <div data-sticky data-margin-top="80" data-sticky-for="768">
                            <div class="row g-4">
                                ...
                                <div class="card card-body text-center bg-dark text-white p-5">
                                    ...
                                    <small class="mb-0">By clicking 'Buy Now', you agree to our <a href="#"
                                            class="text-decoration-underline"> Terms of Service and Privacy
                                            Policy.</a></small>
                                </div>
                            </div><!-- Row End -->
                        </div>
