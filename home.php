         ...
         <div class="container">
             ...
             <div class="row align-items-center g-5">
                 ...
                 <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                     ...
                     <!-- Title -->
                     <h1 class="mb-0 display-6">Find the right

                         <span class="position-relative">freelance
                             <!-- SVG START -->
                     ...
                     <!-- Content -->
                     <p class="my-4 lead">Boost all aspects of your business, ranging from proposals to payments.</p>

                     <!-- Info -->
                     <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
                         <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i><em
                                 class="fw-bold">CreativeHub</em> Certified.</li>
                         <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i><em
                                 class="fw-bold">CreativeHub</em> Pro</li>
                         <li class="list-inline-item"> <i class="bi bi-patch-check-fill h6 me-1"></i><em
                                 class="fw-bold">CreativeHub</em> enterprise</li>
                     </ul>
                     ...
                     <div class="align-items-center justify-content-center justify-content-lg-start">
                         ...
                         <form method="post" class="border rounded p-2 mb-4">
                             <div class="input-group">
                                 <input name="search_query" class="form-control border-0 me-1" type="text"
                                     placeholder="Search for any service..." required>
                                 <button name="search" type="submit" class="btn btn-primary mb-0 rounded"><i
                 ...
                 <div class="col-lg-7 col-xl-6 text-center position-relative">
                     ...
                     <div
                         ...
                         <div class="d-flex justify-content-between align-items-center">
                             ...
                             <div class="text-start ms-3">
                                 <h6 class="mb-0 text-white">CreativeHub Pro <span class="ms-4"><i
                                             class="fas fa-check-circle text-success"></i></span></h6>
                                 <p class="mb-0 small text-white">Your project is completed</p>
                             </div>
                         </div>
                     </div>
                     ...
                     <div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block"
                         ...
                         <p class="text-white">See our qualified professionals</p>
                         <!-- Avatar group -->
                     ...
                     <div class="position-relative">
                         <img src="assets/images/element/07.png" id="img_homeSlider" alt="">
                     </div>
                 </div>
                 <!-- Right content END -->
             </div>
                 ...
                 <div class="col-sm-6 col-xl-3">
                     <div
                         ...
                         <div class="ms-4 h6 fw-normal mb-0">
                             ...
                             <p class="mb-0">Online Job Content</p>
                         </div>
                     </div>
                 </div>
                 <!-- Counter item -->
                 ...
                 <div class="col-sm-6 col-xl-3">
                     <div
                         ...
                         <div class="ms-4 h6 fw-normal mb-0">
                             <div class="d-flex">
                                 <h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0"
                                     data-purecounter-end="7" data-purecounter-delay="200">0</h5>
                                 <span class="mb-0 h5">K+</span>
                             </div>
                             <p class="mb-0">Certified Expertise</p>
                         </div>
                     </div>
                 </div>
                 <!-- Counter item -->
                 <div class="col-sm-6 col-xl-3">
                     <div class="d-flex justify-content-center align-items-center p-4 bg-info bg-opacity-10 rounded-3">
                         ...
                         <div class="ms-4 h6 fw-normal mb-0">
                             <div class="d-flex">
                                 <h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0"
                                     data-purecounter-end="800" data-purecounter-delay="300">0</h5>
                                 <span class="mb-0 h5">+</span>
                             </div>
                             <p class="mb-0">Pro Users</p>
                         </div>
                     </div>
                 </div>
             </div>
         ...
         <div class="container">
             ...
             <div class="row mb-4">
                 <div class="col-lg-8 mx-auto text-center">
                     ...
                     <p class="mb-0">Over hundreds of projects offered by specialized businesses</p>
                 </div>
             </div>
             ...
             <div class="row g-4">
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div class="card card-body bg-dark bg-opacity-10 text-center position-relative btn-transition p-4">
                         ...
                         <!-- Title -->
                         <h5 class="mb-2"><a class="stretched-link">Graphics &amp; Design</a></h5>
                         <h6 class="mb-0">Build Your Brand</h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div
                         ...
                         <h6 class="mb-0">Learn your business</h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div
                         ...
                         <h6 class="mb-0">Develop new applications</h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div
                         ...
                         <!-- Image -->
                         <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                             <img src="assets/images/element/translator.svg" alt="">
                         </div>
                         <!-- Title -->
                         <h5 class="mb-2"><a class="stretched-link">Translate</a></h5>
                         <h6 class="mb-0">Communicate Easily</h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div
                         ...
                         <h6 class="mb-0">Customize your site</h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div class="card card-body bg-info bg-opacity-10 text-center position-relative btn-transition p-4">
                         ...
                         <h6 class="mb-0">Reach more customers</h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div class="card card-body bg-blue bg-opacity-10 text-center position-relative btn-transition p-4">
                         <!-- Image -->
                         <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                             <img src="assets/images/element/customer-service.svg" alt="">
                         </div>
                         <!-- Title -->
                         <h5 class="mb-2"><a class="stretched-link">Consulting</a></h5>
                         <h6 class="mb-0">Improve your ideals</h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div
                         ...
                         <!-- Image -->
                         <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                             <img src="assets/images/element/chatbot.svg" alt="">
                         </div>
                         <!-- Title -->
                         <h5 class="mb-2"><a class="stretched-link">AI Services</a></h5>
                         <h6 class="mb-0">Get Supportive Assistance </h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div
                         ...
                         <h6 class="mb-0">Color your dreams</h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div
                         ...
                         <h6 class="mb-0">Engage your audience</h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div
                         ...
                         <h6 class="mb-0">Unlock growth online</h6>
                     </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-xl-3">
                     <div
                         ...
                         <h6 class="mb-0">Improve your revenue</h6>
                     </div>
                 </div>
             </div>
         </div>
                         ...
                         <div class="row position-relative">
                             ...
                             <div class="col-11 mx-auto position-relative">
                                 <div class="row align-items-center">
                                     <!-- Title -->
                                     <div class="col-lg-7">
                                         <h3 class="text-white">Become an Seller</h3>
                                         <p class="text-white mb-3 mb-lg-0">Take advantage of this complimentary Learn
                                             from <em class="fw-bold">CreativeHub</em> documentation to find out what it
                                             takes to be a top-notch
                                             seller on creativeHub.
                                         </p>
                                     </div>
                                     <!-- Content and input -->
                                     <div class="col-lg-5 text-lg-end">
                                         ...
                                         <a href="become-seller.php"
                                             class="btn btn-lg btn-warning me-2 mb-4 mb-sm-0">Become a Seller<i
...
Trending courses START -->
     <section class="pb-5 pt-0 pt-lg-5">
         <div class="container">
             ...
             <div class="row mb-4">
                 <div class="col-lg-8 mx-auto text-center">
                     <h2 class="fs-1">Our Trending Services</h2>
                     <p class="mb-0">Inspiring work made on CreativeHub 🔥</p>
                 </div>
             </div>
             <div class="row">
                 <!-- Slider START -->
                             ...
                             <div class="card p-2 shadow h-100">
                                 <div class="rounded-top overflow-hidden">
                                     <div class="card-overlay-hover">
                                         <!-- Image -->
                                         <img src="assets/images/courses/4by3/001.png" class="card-img-top"
                                             alt="course image">
                                     </div>
                                     <!-- Hover element -->
                                     <div class="card-img-overlay">
                                         <div class="card-element-hover d-flex justify-content-end">
                                             <a href="#" class="icon-md  text-center video-img"></a>
                                         </div>
                                     </div>
                                 </div>
                                 <!-- Card body -->
                                 <div class="card-body">
                                     ...
                                     <hr>
                                     <!-- Title -->
                                     <h5 class="card-title"><a href="proposals/proposal.php">I will create a
                                             professional minimalist business logo design</a></h5>
                                     <!-- Badge and Price -->
                                     <div class="d-flex justify-content-between align-items-center mb-0">
                                         <a href="#" class="badge bg-info bg-opacity-10 text-info me-2"><i
                                                 class="fas fa-circle small fw-bold"></i> Graphics & Design
                                         </a>
                                         <!-- Price -->
                         ...
                         <div class="col-md-6 col-xl-4">
                             <div class="card p-2 shadow h-100">
                                 <div class="rounded-top overflow-hidden">
                                     <div class="card-overlay-hover">
                                         <!-- Image -->
                                         <img src="assets/images/courses/4by3/005.png" class="card-img-top"
                                             alt="course image">
                                     </div>
                                     <!-- Hover element -->
                                     <div class="card-img-overlay">
                                 ...
                                 <div class="card-body">
                                     ...
                                     <hr>
                                     <!-- Title -->
                                     <h5 class="card-title"><a href="#">I will professionally edit your video using
                                             premiere pro and other Video Editors</a></h5>
                                     <!-- Badge and Price -->
                                     <div class="d-flex justify-content-between align-items-center mb-0">
                                         <a href="#" class="badge bg-danger bg-opacity-10 text-danger me-2"><i
                                                 class="fas fa-circle small fw-bold"></i> Video & Animation </a>
                                         <!-- Price -->
                                         <h3 class="text-success mb-0">$99</h3>
                                     </div>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="col-md-6 col-xl-4">
                             <div class="card p-2 shadow h-100">
                                 <div class="rounded-top overflow-hidden">
                                     <div class="card-overlay-hover">
                                         <!-- Image -->
                                         <img src="assets/images/courses/4by3/002.jpeg" class="card-img-top"
                                             alt="course image">
                                     </div>
                                     <!-- Hover element -->
                                     <div class="card-img-overlay">
                                 ...
                                 <div class="card-body">
                                     ...
                                     <div class="d-flex justify-content-between">
                                         ...
                                         <ul class="list-inline hstack gap-2 mb-0">
                                             ...
                                             <li class="list-inline-item me-0 small"><i
                                                     class="fas fa-star-half-alt text-warning"></i></li>
                                             <li class="list-inline-item ms-2 text-reset">(1120)</li>
                                         </ul>
                                         <!-- d info -->
                                         <ul class="list-inline hstack gap-2 mb-0">
                                             <!-- Info -->
                                     ...
                                     <hr>
                                     <!-- Title -->
                                     <h5 class="card-title"><a href="#">I will do minimalist modern luxury business logo
                                             design</a>
                                     </h5>
                                     <!-- Badge and Price -->
                                     <div class="d-flex justify-content-between align-items-center mb-0">
                                         <a class="badge bg-info bg-opacity-10 text-info me-2"><i
                                                 class="fas fa-circle small fw-bold"></i> Graphics & Design </a>
                                         <!-- Price -->
                         ...
                         <div class="col-md-6 col-xl-4">
                             <div class="card p-2 shadow h-100">
                                 <div class="rounded-top overflow-hidden">
                                     <div class="card-overlay-hover">
                                         <!-- Image -->
                                         <img src="assets/images/courses/4by3/003.jpeg" class="card-img-top"
                                             alt="course image">
                                     </div>
                                     <!-- Hover element -->
                                     <div class="card-img-overlay">
                                 ...
                                 <div class="card-body">
                                     ...
                                     <div class="d-flex justify-content-between">
                                         ...
                                         <ul class="list-inline hstack gap-2 mb-0">
                                             ...
                                             <li class="list-inline-item me-0 small"><i
                                                     class="fas fa-star-half-alt text-warning"></i></li>
                                             <li class="list-inline-item ms-2 text-reset">(700)</li>
                                         </ul>
                                         <!-- info -->
                                         <ul class="list-inline hstack gap-2 mb-0">
                                             <!-- Info -->
                                     ...
                                     <hr>
                                     <!-- Title -->
                                     <h5 class="card-title"><a href="#">I will design website in figma, app ui ux
                                             design</a></h5>
                                     <!-- Badge and Price -->
                                     <div class="d-flex justify-content-between align-items-center mb-0">
                                         <a href="#" class="badge bg-info bg-opacity-10 text-info me-2"><i
                         ...
                         <div class="col-md-6 col-xl-4">
                             <div class="card p-2 shadow h-100">
                                 <div class="rounded-top overflow-hidden">
                                     <div class="card-overlay-hover">
                                         <!-- Image -->
                                         <img src="assets/images/courses/4by3/004.jpeg" class="card-img-top"
                                             alt="course image">
                                     </div>
                                     <!-- Hover element -->
                                     <div class="card-img-overlay">
                                 ...
                                 <div class="card-body">
                                     ...
                                     <div class="d-flex justify-content-between">
                                         ...
                                         <ul class="list-inline hstack gap-2 mb-0">
                                             ...
                                             <li class="list-inline-item me-0 small"><i
                                                     class="fas fa-star-half-alt text-warning"></i></li>
                                             <li class="list-inline-item ms-2 text-reset">(500)</li>
                                         </ul>
                                         <!-- info -->
                                         <ul class="list-inline hstack gap-2 mb-0">
                                             <!-- Info -->
                                     ...
                                     <hr>
                                     <!-- Title -->
                                     <h5 class="card-title"><a href="#">I will design, redesign or clone wordpress
                                             website, ecommerce website</a></h5>
                                     <!-- Badge and Price -->
                                     <div class="d-flex justify-content-between align-items-center mb-0">
                                         <a href="#" class="badge bg-warning bg-opacity-10 text-warning me-2"><i
                                                 class="fas fa-circle small fw-bold"></i> Programming & Tech </a>
                                         <!-- Price -->
         ...
         <div class="container">
             <div class="row g-4 g-lg-5 align-items-center">
                         ...
                         <div class="col-md-7 position-relative mb-0 mt-0 mt-md-5">
                             ...
                             <div class="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                                 ...
                                 <div class="avatar avatar-xl mb-3">
                                     <img class="avatar-img rounded-circle" src="assets/images/avatar/14.jpg"
                                         alt="avatar">
                                 </div>
                                 <!-- Content -->
                                 <blockquote>
                                     <p>
                                         ...
                                         When you want to create a business bigger than yourself, you need a lot of
                                         help. That's what CreativeHub does.
                         ...
                         <div class="col-md-5 mt-5 mt-md-0 d-none d-md-block">
                             <div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                                 ...
                                 <div class="d-flex align-items-center mb-3">
                                     <!-- Avatar -->
                                     <div class="avatar avatar-sm">
                                         <img class="avatar-img rounded-1" src="assets/images/avatar/13.jpg"
                                             alt="avatar">
                                     </div>
                                     <!-- Info -->
                                     <div class="ms-2">
                                         <h6 class="mb-0">Larry Stevens</h6>
                                         <p class="mb-0 small">Data Analysis Services</p>
                                     </div>
                                 </div>
                                 ...
                                 <div class="d-flex align-items-center mb-3">
                                     ...
                                     <div class="ms-2">
                                         ...
                                         <p class="mb-0 small">Web Development Services</p>
                                     </div>
                                 </div>
                                 ...
                                 <div class="d-flex align-items-center">
                                     <!-- Avatar -->
                                     <div class="avatar avatar-sm">
                                         <img class="avatar-img rounded-1" src="assets/images/avatar/11.jpg"
                                             alt="avatar">
                                     </div>
                                     <!-- Info -->
                                     <div class="ms-2">
                                         <h6 class="mb-0">Cole Lawson</h6>
                                         <p class="mb-0 small">Marking Services</p>
                                     </div>
                                 </div>
                             </div>
                         </div>
                     ...
                     <div class="row mt-5 mt-xl-0">
                         ...
                         <div class="col-md-5 mt-n6 mb-0 mb-md-5">
                             <div class="bg-body shadow text-center p-4 rounded-3">
                                 <!-- Avatar -->
                                 <div class="avatar avatar-xl mb-3">
                                     <img class="avatar-img rounded-circle" src="assets/images/avatar/15.jpg"
                                         alt="avatar">
                                 </div>
                                 <!-- Content -->
                                 <blockquote>
                                     <p>
                                         <span class="me-1 small"><i class="fas fa-quote-left"></i></span>
                                         "We've used CreativeHub for Shopify web development, graphic design, and
                                         backend web development. Working with CreativeHub makes my job a little easier
                                         every day."
                                         <span class="ms-1 small"><i class="fas fa-quote-right"></i></span>
                                     </p>
                                 </blockquote>
                 ...
                 <div class="col-xl-5 order-1 text-center text-xl-start">
                     ...
                     <p>We create opportunities for anyone in the world to build their business, brand, or dream.
                         We’re all about providing a conducive online platform environment so that everyone can profit,
                         thrive, and be the best version of themselves. All of our locations showcase items made by
                         CreativeHub sellers. Explore some of our offices here.
                     </p>
                     <a href="#" class="btn btn-lg btn-warning me-2 mb-4 mb-sm-0">View Reviews <i
                             class="bi bi-arrow-right ms-2"></i></a>
                 </div>
             </div> <!-- Row END -->
         </div>
                     ...
                     <div class="bg-warning rounded-3 shadow p-3 p-sm-4 position-relative overflow-hidden">
                         ...
                         <div class="row">
                             <div class="col-md-8 mx-auto text-center py-5 position-relative">
                                 <!-- Title -->
                                 <h2>Subscribe to our Newsletter for New Features Updates</h2>
                                 <!-- Form -->
