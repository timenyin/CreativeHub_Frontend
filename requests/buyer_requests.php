                        ...
                        <div class="my-3 my-xl-0 px-4 flex-nowrap align-items-center">
                            <div class="w-100">
                                <form class="rounded position-relative">
                                    <input id="search-input" class="form-control pe-5 py-3 bg-secondary bg-opacity-10 border-0" type="search" placeholder="Search for buyer request" aria-label="Search">
                            ...
                            <div class="offcanvas-body p-3 p-xl-0">
                                <div class="bg-dark border rounded-3 pb-0 p-3 w-100">
                                    ...
                                    <div class="list-group list-group-dark list-group-borderless">
                                        <a class="list-group-item" href="../dashboard.php"><i class="text-danger bi bi-ui-checks-grid fa-fw me-2"></i>Dashboard</a>

                                        <!-- Dropdown for Marking -->
                                        <div class="list-group-item dropdown">
                                            <div class="dropdown-toggle" href="#" id="earningDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                <i class="text-warning bi bi-shop-window fa-fw me-2"></i>Seller
                                            </div>
                                            <ul class="dropdown-menu" aria-labelledby="earningDropdown">
                                                <li><a class="dropdown-item" href="../selling_orders.php"><i class="text-warning bi bi-border-style fa-fw me-2"></i>Order</a>
                                                </li>
                                                <li><a class="dropdown-item" href="../proposals/view_proposals.php"><i class="text-warning bi bi-yelp fa-fw me-2"></i>View
                                                        Proposal</a></li>
                                                <li><a class="dropdown-item" href="../requests/buyer_requests.php"><i class="text-warning bi bi-envelope-heart fa-fw me-2"></i>Request</a>
                                                </li>
                                                <li><a class="dropdown-item" href="revenue.php"><i class="text-warning bi bi-coin fa-fw me-2"></i>Revenue</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="list-group-item dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="earningDropdown">
                                                <li><a class="dropdown-item" href="../buying_orders.php"><i class="text-info bi bi-border-style fa-fw me-2"></i>Order</a>
                                                </li>
                                                <li><a class="dropdown-item" href="../purchases.php"><i class="text-info bi bi-cash-coin fa-fw me-2"></i>Payments</a>
                                                </li>
                                                <li><a class="dropdown-item" href="../favourites.php"><i class="text-info bi bi-heart-half fa-fw me-2"></i>Favorite</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="list-group-item dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="earningDropdown">
                                                <li><a class="dropdown-item" href="../requests/post_request.php"><i class="text-success bi bi-send-plus fa-fw me-2"></i>Post
                                                        Request</a></li>
                                                <li><a class="dropdown-item" href="../requests/manage_requests.php"><i class="text-success bi bi-kanban fa-fw me-2"></i>Manage
                                                        Request</a></li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="list-group-item dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="earningDropdown">
                                                <li><a class="dropdown-item" href="../manage_contacts.php?my_buyers">
                                                        ...
                                                        Buyers</a></li>
                                                <li><a class="dropdown-item" href="../manage_contacts.php?my_sellers"><i class="text-orange fa-solid fa-people-group pe-1"></i>My
                                                        Sellers</a></li>
                                            </ul>
                                        </div>
                                        <a class="list-group-item" href="my_referrals.php"><i class="text-purple bi bi-people-fill fa-fw me-2"></i>My Referrals</a>
                                        <a class="list-group-item" href="../conversations/inbox.php"><i class="text-success opacity-10 bi bi-chat-text-fill fa-fw me-2"></i>Conversation</a>
                                        <a class="list-group-item" href="../user.php"><i class="text-info opacity-10 bi bi-person-lines-fill fa-fw me-2"></i>My
                                            Profile</a>
                                        ...
                                        <div class="list-group-item dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="earningDropdown">
                                                <li><a class="dropdown-item" href="settings.php?profile_settings">
                                                        ...
                                                        Settings</a></li>
                                                <li><a class="dropdown-item" href="settings.php?account_settings"><i class="text-danger bi bi-person-gear fa-fw me-2"></i>Account
                                                        Settings</a></li>
                                            </ul>
                                        </div>
                                        <a class="list-group-item  bg-danger-soft-hover" href="#!"><i class="fas fa-sign-out-alt fa-fw me-2"></i>Sign out</a>
                                    </div>
                                    <div id="extwaiokist" style="display:none" v="nipgg" q="b7567393" c="288.3" i="297" u="3.296" s="05202423" sg="svr_09102316-ga_05202423-bai_05232420" d="1" w="false" e="" a="3" m="BMe=" vn="9adfy">
                                        <div id="extwaigglbit" style="display:none" v="nipgg" q="b7567393" c="288.3" i="297" u="3.296" s="05202423" sg="svr_09102316-ga_05202423-bai_05232420" d="1" w="false" e="" a="3" m="BMe=">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card shadow rounded-2 p-0">
                            ...
                            <div class="card-header border-bottom px-4 py-3">
                                <ul class="nav nav-pills nav-tabs-line py-0" id="course-pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item me-2 me-sm-4" role="presentation">
                                        <button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#active-proposal-pills" type="button" role="tab" aria-controls="active-proposal-pills" aria-selected="true" tabindex="0">
                                            Active
                                            <span class="badge bg-purple rounded-circle bg-opacity-10 ms-1 text-purple">7</span>
                                        </button>
                                    </li>
                                    <!-- Tab item -->
                                    <li class="nav-item me-2 me-sm-4" role="presentation">
                                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-4" data-bs-toggle="pill" data-bs-target="#pending-approval-pills" type="button" role="tab" aria-controls="pending-approval-pills" aria-selected="true" tabindex="0">
                                            Offers Sent
                                            <span class="badge bg-success rounded-circle bg-opacity-10 ms-1 text-success">7</span>
                                        </button>
                                    </li>
                            ...
                            <div class="card-body p-4">
                                <div class="tab-content pt-2" id="course-pills-tabContent">
                                    <!-- Tab Pane -->
                                    <div class="tab-pane fade show active" id="active-proposal-pills" role="tabpanel" aria-labelledby="course-pills-tab-1">
                                        <div class="row mb-3">
                                            <div class="col-md-6">

                                            </div>
                                            <div class="col-md-6">
                                                <select id="sub-category" class="form-select border-warning" aria-label="Default select example">
                                                ...
                                                <div id="request_tr_4" class="row align-items-center p-3">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                ...
                                                                <div class="d-flex align-items-center gap-3">
                                                                    ...
                                                                    <div class="avatar flex-shrink-0">
                                                                        <img class="avatar-img rounded-circle" src="../user_images/03.jpg" alt="avatar">
                                                                    </div>
                                                                    <!-- Info -->
                                                                    <div>
                                                                        <h5 class="ps-0 mb-0 h6 fw-light">Dennis Barrett
                                                                        </h5>
                                                                        <span class="d-none d-sm-flex badge bg-success bg-opacity-10 text-success rounded-0 py-2" style="float: right;">
                                                                            Oct 14th 2023
                                                                        </span>
                                                                        ...
                                                                        <a href="#" class="badge bg-warning bg-opacity-10 text-warning rounded-0 px-2 py-2">
                                                                            <i class="bi bi-paperclip"></i>
                                                                            information.txt
                                                                        </a>
                                                                        <hr class="border-0 my-2">
                                                                        <span class="badge bg-secondary bg-opacity-10 text-secondary rounded-0 px-2 py-2">HTML&CSS</span>
                                                                        <span class="badge bg-secondary bg-opacity-10 text-secondary rounded-0 px-2 py-2">Web
                                                                            design</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6 pt-2 pt-md-0">
                                                        <div class="row">
                                                            ...
                                                            <!-- Check -->
                                                            <div class="col-4 d-flex justify-content-center">
                                                                <div class="icon-md_min bg-success bg-opacity-10 rounded-circle text-success">
                                                                    Day 3</div>
                                                            </div>
                                                            <!-- Check -->
                                                            <div class="col-4 d-flex justify-content-center">
                                                                <div class="icon-md bg-success bg-opacity-10 rounded-circle text-success">
                                                                    $15</div>
                                                                <!-- send offer  button -->
                                                                <div class="dropdown icon-md ms-1 bg-warning bg-opacity-10 rounded-circle text-success shear_4" style="cursor: pointer; visibility: hidden;">
                                                                    <!-- Share button -->
                                                                    ...
                                                                    <ul class="dropdown-menu ms-4 dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded" aria-labelledby="dropdownShare" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(0px, 36px);" data-popper-placement="bottom-end">
                                                                        <li>
                                                                            <div class="dropdown-item btn btn-sm text-warning me-2 mb-4 mb-sm-0 send_button_4">
                                                                                <i class="bi bi-link-45deg animation-blink" aria-hidden="true"></i> send offer
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="dropdown-item btn btn-sm text-warning me-2 mb-4 mb-sm-0 remove_request_4">
                                                                                <i class="bi bi-link-45deg animation-blink" aria-hidden="true"></i> Delete
                                                                                Request
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                        ...
                                                        <div class="card card-body border">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                ...
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <!-- Avatar -->
                                                                    <div class="avatar flex-shrink-0">
                                                                        <img class="avatar-img rounded-circle" src="../user_images/07.jpg" alt="avatar">
                                                                    </div>
                                                                    <!-- Info -->
                                                                    <div>
                                                                        <h5 class="ps-0 mb-0 h6 fw-light">Dennis Barrett
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4 d-flex justify-content-center">
                                                                <div class="icon-md bg-success bg-opacity-10 rounded-circle text-success">
                                                                    $15</div>
                                                                <!-- send offer  button -->
                                                                <div class="dropdown icon-md ms-1 bg-warning bg-opacity-10 rounded-circle text-success shear_5" style="cursor: pointer; visibility: hidden;">
                                                                    <!-- Share button -->
                                                                    <a href="#" class="rounded small text-warning" role="button" id="dropdownShare" data-bs-toggle="dropdown" aria-expanded="false" data-bs-placement="top" aria-label="Share" data-bs-original-title="Share">
                                                                        <i class="fas fa-fw fa-share-alt" aria-hidden="true"></i>
                                                                    </a>
                                                                    <ul class="dropdown-menu ms-4 dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded" aria-labelledby="dropdownShare" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(0px, 36px);" data-popper-placement="bottom-end">
                                                                        <li>
                                                                            <div class="dropdown-item btn btn-sm text-warning me-2 mb-4 mb-sm-0 send_button_5" data-bs-toggle="modal" data-bs-target="#quota-finish">
                                                                                <i class="bi bi-link-45deg animation-blink" aria-hidden="true"></i> send offer
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="dropdown-item btn btn-sm text-warning me-2 mb-4 mb-sm-0 remove_request_5">
                                                                                <i class="bi bi-link-45deg animation-blink" aria-hidden="true"></i> Delete
                                                                                Request
                                                                            </div>
                                                                        </li>
                                    ...
                                    <!-- Tab Pane -->
                                    <div class="tab-pane fade show" id="pending-approval-pills" role="tabpanel" aria-labelledby="course-pills-tab-4">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content" style="border-radius: 5px !important;">
                <div class="modal-body">
                    <div class="alert alert-light alert-dismissible d-lg-flex justify-content-between align-items-center shadow p-4 " role="alert">
                        <div>
                        ...
                        <div class="d-flex mt-3 mt-lg-0">
                            ...
                            <div class="position-absolute end-0 top-0 mt-n3 me-n3">
                                <button type="button" class="btn btn-danger btn-round btn-sm mb-0" data-bs-dismiss="modal">
