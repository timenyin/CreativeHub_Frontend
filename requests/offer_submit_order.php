<div id="featured-request-modal" class="modal fade">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="paypal-form">
                    ...
                    <input type="hidden" name="cancel_return" value="requests/view_proposals.php">
                    <input type="hidden" name="return" value="paypal_order.php?view_offers=offer_id=">
                ...
                <form action="featured_listing_charge.php" method="post" id="credit-card-form">
                    ...
                    <input type="hidden" name="amount" value="">
                    <input type="submit" class="btn btn-sm img-fluid btn-success w-100 strip-submit" value="Pay With Credit Card" data-key="pk_test_51L0aZcCWHilK5BnHfZxMQvDox3IL5sxEdgDTk0HCMpTi8fpZ1oCirU5rubFihfXKwzE5lzfqUwDNxkkm5EY5LGgO008ZvMxeF4" data-amount="2000" data-currency="usd" data-email="creativehubmessage@gmail.com" data-name="Creativehub" data-image="assets/images/payment_icon.svg" data-description="Cart Proposals Payment" data-allow-remember-me="false">
