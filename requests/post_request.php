...
Page Banner END -->
        ...
        <section class="pt-0 pt-lg-5">
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <h2 class="mb-0">Manger your Request </h2>
                    </div>
                </div>
                                ...
                                <div class="row g-4 g-md-5 justify-content-between">
                                    <div class="col-lg-12 mb-5">
                                        <div class="bg-dark rounded-3 p-4 p-sm-5 position-relative">
                                            ...
                                            <!-- Form START -->
                                            <form method="post" enctype="multipart/form-data" class="row g-3 position-relative">
                                                <!-- First name -->
                                                <div class="col-md-12 bg-dark-input">
                                                    <label class="form-label text-white text-opacity-50">Request title
                                                ...
                                                <!-- Upload Files  -->
                                                <div class="col-md-12 bg-dark-input">
                                                    <label class="form-label text-white text-opacity-50">Upload File
                                                        <span class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input class="form-control stretched-link" type="file" name="request_file" id="file" required>
                                                    </div>
                                                </div>

                                                <!-- description -->
                                                <div class="col-12 bg-dark-input">
                                                    <label class="form-label text-white text-opacity-50">Request
                                                        Description<span class="text-danger">*</span></label> <span class=" text-success my-2 mx-2 ">
                                                        <span class="count"> 0 </span> / 380 Max
                                                    </span></label>
                                                    <textarea class="form-control" name="request_textarea" id="textarea" rows="6" cols="73" maxlength="380" placeholder="Description" required></textarea>
                                                </div>



                                                <hr class="my-3 m-0 border-warning">

                                                <!-- Select a Category -->
                                                <div class="col-md-6 bg-dark-input">
                                                    <label class="form-label text-white text-opacity-50"> Select a
                                                        Category <span class="text-danger">*</span></label>
                                                    <select name="cat_id" id="category" class="form-control" aria-label=".form-select-sm" required>
                                                        <option class="text-secondary hidden" selected="">Select
                                                            Categories
                                                        </option>
                                                        <option value="1" class="text-secondary">Graphics & Design
                                                        </option>
                                                        <option value="2" class="text-secondary">Video &amp; Animation
                                                        </option>
                                                    </select>
                                                </div>

                                                <!-- Select A Sub Category -->
                                                <div id="sub-category" class="col-md-6 bg-dark-input">
                                                    <label class="form-label text-white text-opacity-50">Sub Category
                                                        <span class="text-danger">*</span></label>
                                                    <select name="child_id" class="form-control" aria-label=".form-select-sm" required>
                                                        <option class="text-secondary hidden" selected="">Select
                                                            Categories
                                                        </option>
                                                        <option value="1" class="text-secondary">Logo Design
                                                        </option>
                                                        <option value="2" class="text-secondary">Web Design
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <!-- Amount  -->
                                                <div class="col-md-6 bg-dark-input">
                                                    <label class="form-label text-white text-opacity-50">Amount
                                                        <span class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" name="request_budget" min="5" placeholder="$5 Minium" required>
                                                </div>
                                                ...
                                                <div class="col-md-12 bg-dark-input">
                                                    ...
                                                    <label class="form-label text-white text-opacity-50">Time of
                                                        Delivery</label>
                                                    <small class="text-warning"> (Once you place your order, when would
                                                        you like your service
                                                        delivered?)</small>
                                                    <div class="d-flex">
                                                        <div class="form-check radio-bg-light mx-2">
                                                            <input class="form-check-input time_input_request" type="radio" name="flexRadioDefault" value="1" id="flexRadioDefault1" name="delivery_time" require>
                                                            <label class="form-check-label" for="flexRadioDefault1">
                                                                Day 1
                                                            </label>
                                                        </div>
                                                        <div class="form-check radio-bg-light mx-2">
                                                            <input class="form-check-input time_input_request" type="radio" name="flexRadioDefault" value="3" id="flexRadioDefault2" name="delivery_time" require>
                                                        ...
                                                        <div class="form-check radio-bg-light mx-2">
                                                            <input class="form-check-input time_input_request" type="radio" name="flexRadioDefault" value="3" id="flexRadioDefault3" name="delivery_time" require>
                                                        ...
                                                        <div class="form-check radio-bg-light mx-2">
                                                            <input class="form-check-input time_input_request" type="radio" name="flexRadioDefault" value="3" id="flexRadioDefault4" name="delivery_time" require>
                                                ...
                                                <div class="col-12 bg-dark-input">
                                                    <div class="d-grid">
                                                        <input type="submit" name="submit" value="Post a Request" class="btn btn-lg btn-primary">
                                                    </div>
                                                    <p class="mb-0 text-white text-opacity-50 small">Field required with
                                                        <span class="text-danger fw-bold">*</span> are required to
