<div class="modal-content">
                    ...
                    <div class="col-lg-12">
                        <div class="bg-dark rounded-3 p-4 p-sm-5 position-relative">
                            ...
                            <p class="alert alert-success mb-0 text-opacity-50 small" role="alert">
                                ...
                                within CreativeHub.
                                request <a href="help-&-Support.php" class="alert-link"
                            ...
                            <form id="proposal-details-form" class="row g-3 position-relative mt-4">
                                ...
                                <div class="alert alert-info  d-flex justify-content-between align-items-center mt-2 mb-0 rounded-3 pe-2 my-4"
                                    role="alert">
                                    <div>
                                        <!-- Avatar -->
                                        <div class="avatar avatar-xs me-2">
                                            <img class="avatar-img rounded-circle" src="user_images/03.jpg"
                                                alt="avatar">
                                        </div>
                                        <!-- Info -->
                                        I'm available for this job. i need to do it by 2 days logo Design plug instead
                                ...
                                <div class="col-12 bg-dark-input">
                                    ...
                                    <textarea name="description" class="form-control" rows="3" placeholder=""
                                        data-gramm="false" wt-ignore-input="true" require></textarea>
                                </div>
                                ...
                                <div class="col-md-6 bg-dark-input col-lg-12 col-xl-6 mb-2 mt-4">
                                    <label class="form-label text-white text-opacity-50">Total Offer Amount
                                        :</label>
                                    <input type="number" name="amount" class="form-control" id="firstName" min="5"
    ...
    <div class="modal-footer ">
        <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal"
            data-bs-target="#send-offer-modal" data-bs-toggle="modal"><i class="bi bi-arrow-left ms-2"></i>Back</button>


        <button type="submit" class="btn btn-sm btn-warning">Submit Request <i
