                ...
                <div class="row g-4">
                        ...
                        <div class="card p-2 bg-transparent border">
                            <div class="row g-0">
                                <div class="col-md-3 pt-4">
                                    <img src="../images/card_logo.png" class="rounded-2" alt="Card image">
                                </div>
                                <div class="col-md-9">
                                    <div class="card-body">
                                        <!-- Badge and dropdown -->
                                        <div class="d-flex justify-content-between">
                                            <!-- Badge -->
                                            <div>
                                                <a href="sellingon.php" class="badge text-bg-primary">Seller</a>
                                                <a href="buyingon.php" class="badge text-bg-dark">Purchaser</a>
                                            </div>
                                            ...
                                            <div class="dropdown flex-shrink-0">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end min-w-auto"
                                                    ...
                                                    <li><a class="dropdown-item" href="help-&-Support.php">Help
                                                            & Support</a></li>
                                                    <li><a class="dropdown-item" href="consumer&services.php">Consumer
                                                            Services</a></li>
                                                    <li><a class="dropdown-item" href="terms-of-service.php">Terms
                                                            of Service</a></li>
                                                    <li><a class="dropdown-item" href="property-claims.php">Property
                                                            Claims</a></li>
                                                </ul>
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title mt-3 mb-0"><a href="help-&-Support.php">Search here to
                                                get answers to your questions and seller management services</a></h5>

                                        <!-- Progress item -->
                                        <div class="overflow-hidden mt-3">
                                            <div class="d-flex justify-content-between">
                                                <h6 class="uppercase">Get Free Instructions </h6>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-3">
                                            ...
                                            <ul class="nav nav-divider small mb-0">
                                                <li class="nav-item h6 mb-0">Process System</li>
                                                <li class="nav-item">Services Provider </li>
                                            </ul>

                                            <!-- Dropdown -->
                                            <a href="sellingon.php" class="btn btn-sm btn-primary-soft mb-0">View
                                                Steps</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card card-body bg-transparent border">
                            <h6 class="mb-3">Post a New Request </h6>
                            <!-- List -->
                            <div class="d-flex align-items-center position-relative view-proposals">
                                <!-- Content -->
                                <div class="ms-3">
                                    <a href="post_request.php" class="btn btn-success">Create New Request </a>
                                ...
                                <ul class="nav nav-pills nav-tabs-line py-0" id="course-pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item me-2 me-sm-4" role="presentation">
                                        <button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1"
                                            ...
                                            Active
                                            <span
                                                class="badge bg-purple rounded-circle bg-opacity-10 ms-1 text-purple">2</span>
                                        </button>
                                    </li>
                                    ...
                                    <li class="nav-item me-2 me-sm-4" role="presentation">
                                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-3"
                                            data-bs-toggle="pill" data-bs-target="#paused-pills" type="button"
                                            role="tab" aria-controls="paused-pills" aria-selected="false" tabindex="-1">
                                            Paused
                                            <span
                                                class="badge bg-orange rounded-circle bg-opacity-10 ms-1 text-orange">2</span>
                                        </button>
                                    </li>
                                    ...
                                    <li class="nav-item me-2 me-sm-4" role="presentation">
                                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-4"
                                            ...
                                            Pending
                                            <span
                                                class="badge bg-success rounded-circle bg-opacity-10 ms-1 text-success">2</span>
                                        </button>
                                    </li>
                                    ...
                                    <li class="nav-item me-2 me-sm-4" role="presentation">
                                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-2"
                                            data-bs-toggle="pill" data-bs-target="#request-modification-pills"
                                            type="button" role="tab" aria-controls="request-modification-pills"
                                            aria-selected="false" tabindex="-1">
                                            Unapproved
                                            <span
                                                class="badge bg-primary rounded-circle bg-opacity-10 ms-1 text-primary">2</span>
                                        </button>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="tab-content pt-2" id="course-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="active-proposal-pills" role="tabpanel"
                                        ...
                                        <!-- Content for Pending Approval tab -->
                                        <div class="card border bg-transparent rounded-3">
                                            <!-- Card header START -->
                                            <div class="card-header bg-transparent border-bottom">
                                                <h3 class="mb-0">Active Request Details</h3>
                                            </div>
                                            <!-- Card header END -->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="table-responsive border-0">
                                                    <table
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th scope="col" class="border-0 rounded-start">Title
                                                                </th>
                                                                <th scope="col" class="border-0">Description</th>
                                                                <th scope="col" class="border-0 text-center">Date</th>
                                                                <th scope="col" class="border-0">Offers</th>
                                                                <th scope="col" class="border-0">Budget</th>
                                                                <th scope="col" class="border-0 rounded-end">Actions
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="pb-5">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-start">
                                                                        ...
                                                                        <div>
                                                                            <!-- Title -->
                                                                            <h6><a
                                                                                    href="order_details.php?selling_order">
                                                                                    Please Quota me </a></h6>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-start">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <h6><a
                                                                                    href="order_details.php?selling_order">
                                                                                    Please quote for a platform exactly
                                                                                    like Netflix</a></h6>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <!-- views item -->
                                                                <td>
                                                                    <div class="text-center">December 12th, 2023</div>
                                                                </td>
                                                                <!-- order item -->
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="dropdown flex-shrink-0">
                                                                        <a href="#"
                                                                            class="text-primary-hover text-purple p-0 mb-0"
                                                                            id="cardShareAction2"
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-menu-end min-w-auto"
                                                                            ...
                                                                            <li><a class="dropdown-item"
                                                                                    href="view_offers.php?request_id="
                                                                                    target="blank">View Offer</a></li>
                                                                            <li><a class="dropdown-item"
                                                                                    href="pause_request.php?request_id=">Pause</a>
                                                                            </li>
                                                                            <li><a class="dropdown-item bg-danger-soft-hover"
                                                                                    href="delete_request.php?request_id=">Delete</a>
                                                                            </li>
                                                                        </ul>
                                    ...
                                    <div class="tab-pane fade show" id="pending-approval-pills" role="tabpanel"
                                        ...
                                        <div class="card border bg-transparent rounded-3">
                                            <!-- Card header START -->
                                            <div class="card-header bg-transparent border-bottom">
                                                <h3 class="mb-0">Pending Request Details</h3>
                                            </div>
                                            <!-- Card header END -->
                                                            ...
                                                            <tr class="pb-5">
                                                                ...
                                                                <td>
                                                                    <a href="order_details.php?selling_order"
                                                                        ...
                                                                        aria-describedby="tooltip465336"
                                                                        class="btn btn-sm btn-danger-soft btn-round me-1 mb-0"><i
                                    ...
                                    <!-- Tab Pane -->
                                    <div class="tab-pane fade" id="request-modification-pills" role="tabpanel"
                                        aria-labelledby="course-pills-tab-2">
                                        <!-- Content for Request Modification tab -->
                                        <div class="card border bg-transparent rounded-3">
                                            <!-- Card header START -->
                                            <div class="card-header bg-transparent border-bottom">
                                                <h3 class="mb-0">Unapproved Request Details</h3>
                                            </div>
                                            <!-- Card header END -->
                                    ...
                                    <!-- Tab Pane -->
                                    <div class="tab-pane fade" id="paused-pills" role="tabpanel"
                                        aria-labelledby="course-pills-tab-3">
                                        <!-- Content for Paused tab -->
                                        <div class="card border bg-transparent rounded-3">
                                            <!-- Card header START -->
                                            <div class="card-header bg-transparent border-bottom">
                                                <h3 class="mb-0">Pause Request Details</h3>
                                            </div>
                                            <!-- Card header END -->
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="dropdown flex-shrink-0">
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-menu-end min-w-auto"
                                                                            ...
                                                                            <li><a class="dropdown-item"
                                                                                    href="active_request.php?request_id=">Active</a>
                                                                            </li>
                                                                            <li><a class="dropdown-item bg-danger-soft-hover"
                                                                                    href="delete_request.php?request_id=">Delete</a>
                                                                            </li>
