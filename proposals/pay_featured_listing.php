<div id="featured-request-modal" class="modal fade" tabindex="-1" aria-labelledby="featured-request-modal" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header border-0">
                ...
                <h5 class="modal-title"> Pay For Featured Proposal </h5>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="rounded-3 p-4 p-sm-5 position-relative">
                                    ...
                                    <div class="order-details card-body mt-5">
                                        <!-- Badge and dropdown -->
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="">
                                                        <!-- Badge -->
                                                        <div>
                                                            <span class="badge bg-success bg-opacity-10 text-success rounded-0 px-2 py-2">Listing
                                                                Fee: <span class="fw-bolder">$20</span></span>
                                                            <span class="badge bg-success bg-opacity-10 text-success rounded-0 px-2 py-2">Duration:
                                                                3 Days </span>



                                                            <div class="alert alert-success alert-dismissible d-flex justify-content-between align-items-center fade show py-2 px-2 mb-2 rounded-0 mt-1 ">
                                                                <div>
                                                                    <span class="fw-bolder">Proposal Description:</span>
                                                                    I Will Do Web Development In Laravel And React
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <h5 class="card-title mt-1 mb-0 ">
                                                <small class="fw-bold">Proposal Amount:
                                                    <span>This payment is Related to the Following Proposal for
                                                        an amount of
                                                    </span>
                                                    <span class="price text-success display-5 lead"> $20
                                                    </span>
                                                </small>

                                            </h5>
                                            <div class="alert alert-success alert-dismissible d-flex justify-content-between align-items-center fade show py-2 pe-2 mb-2" role="alert">
                                                <div>
                                                    <i class="bi bi-exclamation-octagon-fill me-2"></i>
                                                    You are about to pay for the featured listing fee for your proposal.
                                                    ...
                                                    <div class="card card-body border">
                                                        <div class="d-xl-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="payment_option" id="shopping-balance" checked>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="col-md-12 text-center text-md-start">
                                                            ...
                                                            <div class="card card-body border">
                                                                <div class="d-xl-flex justify-content-between align-items-center">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="payment_option" id="paypal">
                                                                            ...
                                                                            <div class="d-sm-flex justify-content-between align-items-center">
                                                                                ...
                                                                                <div class="col-lg-auto mt-4">
                                                                                    <span class="float-right mr-4">
                                                                                        <img class="checkout_payment_img" src="../assets/images/element/paypalpay.svg" width="120" height="120">
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="col-md-12 text-center text-md-start">
                                                            ...
                                                            <div class="card card-body border">
                                                                <div class="d-xl-flex justify-content-between align-items-center">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="payment_option" id="credit-card">
                                                                    </div>
                                                                    <ul class="list-inline vstack gap-4 flex-wrap mt-1 ms-3">
                                                                        <!-- Item -->
                                                                        <li class="list-inline-item  me-0">
            ...
            <div class="modal-footer">
                ...
                <form action="../shopping_balance.php" method="post" id="shopping-balance-form">
                    ...
                    <button type="submit" name="view_offers_submit_order" class="btn btn-sm btn-success " onclick="return confirm('Do You Really Want to Order This Offer From Your Shopping Balance.')">
                        Place Order
                    </button>
                </form>
                ...
                <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="paypal-form">
                    ...
                    <input type="hidden" name="cancel_return" value="http://localhost/freelance/requests/view_proposals.php">
                    <input type="hidden" name="return" value="http://localhost/freelance/paypal_order.php?view_offers=offer_id=">

                    <input type="hidden" name="item_name" value="I Will Do Web Development In Laravel And React">
                ...
                <form action="offer_charge.php" method="post" id="credit-card-form">
                    ...
                    <input type="hidden" name="offer_id" value="">
                    <input type="hidden" name="amount" value="">
                    <input type="submit" class="btn btn-sm img-fluid btn-success w-100 strip-submit" data-key="pk_test_51L0aZcCWHilK5BnHfZxMQvDox3IL5sxEdgDTk0HCMpTi8fpZ1oCirU5rubFihfXKwzE5lzfqUwDNxkkm5EY5LGgO008ZvMxeF4" value="Pay With Credit Card" data-amount="2000" data-currency="usd" data-email="creativehubmessage@gmail.com" data-name="creativehub.com" data-image="http://localhost/CreativeHub/assets/images/payment_icon.svg" data-description="I Will Do Web Development In Laravel And React" data-allow-remember-me="false">
