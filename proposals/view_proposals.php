...
Page Banner END -->
        ...
        <section class="pt-0 pt-lg-5">
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <h2 class="mb-0">Manger your Proposals </h2>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-xl-4">
                        <div class="card card-body bg-transparent border">
                            <h6 class="mb-3 ">Vacation Mode</h6>
                            <!-- List -->
                            <div class="d-flex align-items-center position-relative view-proposals">
                                <label class="">
                                    <!-- pull-right lead Starts -->
                                    <button id="turn_on_seller_vacation" data-toggle="button"
                                        class="btn btn-lg btn-toggle">
                                        <div class="toggle-handle"></div>
                                    </button>

                                    <button id="turn_off_seller_vacation" data-toggle="button"
                                        class="btn btn-lg btn-toggle active">
                                        <div class="toggle-handle"></div>
                                    </button>
                                </label>
                                <span class="text-warning" style="font-size:2rem;"> <i
                                        class="bi bi-signpost-split-fill"></i> </span>
                                <!-- Content -->
                                <div class="ms-3">
                                    <a href="create_proposal.php" class="btn btn-success ">Create Proposal </a>
                                ...
                                <ul class="nav nav-pills nav-tabs-line py-0" id="course-pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item me-2 me-sm-4" role="presentation">
                                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-3"
                                            ...
                                            Paused
                                            <span
                                                class="badge bg-orange rounded-circle bg-opacity-10 ms-1 text-orange">4</span>
                                        </button>
                                    </li>
                                    ...
                                    <li class="nav-item me-2 me-sm-4" role="presentation">
                                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-2"
                                            ...
                                            <span
                                                class="badge bg-primary rounded-circle bg-opacity-10 ms-1 text-primary">3</span>
                                        </button>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="tab-content pt-2" id="course-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="active-proposal-pills" role="tabpanel"
                                        ...
                                        <?php include('../proposals/active_proposal_pills.php') ?>
                                    </div>
                                    ...
                                    <div class="tab-pane fade show" id="pending-approval-pills" role="tabpanel"
                                        ...
                                        <!-- Content for Pending Approval tab -->
                                        <?php include('../proposals/pending_approval_pills.php') ?>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="request-modification-pills" role="tabpanel"
                                        ...
                                        <?php include('../proposals/request_modification_pills.php') ?>
                                    </div>
                                    <!-- Tab Pane -->
                                    <div class="tab-pane fade" id="paused-pills" role="tabpanel"
                                        aria-labelledby="course-pills-tab-3">
                                        <!-- Content for Paused tab -->
                                        <?php include('../proposals/paused_pills.php') ?>
                                    </div>
                                </div>
                            </div>
                            <!-- Tab contents END -->
