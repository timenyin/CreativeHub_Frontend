     ...
     <div class="container">
         ...
         <div class="row g-4">
             ...
             <div class="col-lg-3">
                 ...
                 <p class="my-3">Explore an array of practical online resources on digital marketing, video animation,
                 ...
                 <div class="row g-4">
                     ...
                     <div class="col-6 col-md-4">
                         ...
                         <ul class="nav flex-column">
                             ...
                             <li class="nav-item"><a class="nav-link" href="terms-of-service.php">Terms of Service</a>
                             </li>
                             <li class="nav-item"><a class="nav-link" href="property-claims.php">Property Claims</a>
                             </li>
                     ...
                     <div class="col-6 col-md-4">
                         ...
                         <ul class="nav flex-column">
                             ...
                             <li class="nav-item"><a class="nav-link" href="consumer&services.php">Consumer Services</a>
                             </li>
                     ...
                     <div class="col-6 col-md-4">
                         ...
                         <ul class="nav flex-column">
                             ...
                             <li class="nav-item"><a class="nav-link" href="invent_friend.php">Invent a Friend</a></li>
                             <li class="nav-item"><a class="nav-link" href="become-seller.php">Become a Seller</a></li>
                             </li>
                         </ul>
                     </div>
                 </div>
