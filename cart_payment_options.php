                        ...
                        <div class="card card-body shadow p-4">
                            ...
                            <div class="alert alert-success alert-dismissible d-flex justify-content-between align-items-center fade show py-2 pe-2" role="alert">
                                <div>
                                    ...
                                    Your are spending from your Deposit Account ? <a href="#" class="text-reset btn-link mb-0 fw-bold">View Dashboard </a>
                                </div>
                                            ...
                                            <div class="card card-body border">
                                                <div class="d-xl-flex justify-content-between align-items-center">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="method" id="shopping-balance" checked>
                                                        ...
                                                        <li class="list-inline-item  me-0">
                                                            <div class="d-sm-flex justify-content-between align-items-center mb-3">
                                                                <div class="d-sm-flex align-items-center">
                                                                    <!-- Image -->
                                                                    <img src="assets/images/avatar/02.jpg" class="rounded-circle me-3 mb-2 mb-sm-0 h-70px" alt="">
                                                                    <!-- Title -->
                                                                ...
                                                                <!-- Year -->
                                                                <h6 class="mb-0 badge bg-success rounded-0 px-2 py-2 bg-opacity-20 ">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12 text-center text-md-start">
                                                ...
                                                <div class="card card-body border">
                                                    <div class="d-xl-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="method" id="paypal" check>
                                                                ...
                                                                <div class="d-sm-flex justify-content-between align-items-center">
                                                                    ...
                                                                    <div class="col-lg-auto mt-4">
                                                                        <span class="float-right mr-4">
                                                                            <img class="checkout_payment_img" src="assets/images/element/paypalpay.svg" width="120" height="120" class="ms-2 width-xs-100">
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12 text-center text-md-start">
                                                ...
                                                <div class="card card-body border">
                                                    <div class="d-xl-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" id="credit-card" name="method" check>
                                                        </div>
                                                        <ul class="list-inline vstack gap-4 flex-wrap mt-1 ms-3">
                                                            <!-- Item -->
                                                            <li class="list-inline-item  me-0">
                                                                <div class="d-sm-flex justify-content-between align-items-center">
                                                                    ...
                                                                    <div class="col-lg-auto mt-4">
                                                                        <span class="float-right me-3">
                                                                            <img src="assets/images/element/creditCardPay.svg" width="90" height="90" class="ml-2 width-xs-100">
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                ...
                                <div class="card card-body shadow p-4 mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-3">
                                                ...
                                                <div class="text-primary-hover">
                                                    <a href="cart_payment_options.php?remove_proposal" class="text-body me-2"><i class="bi bi-trash me-1"></i>Remove</a>
                                                    <a href="proposals/proposal.php" class="text-body me-2"><i class="bi bi-pencil-square me-1"></i>Edit</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-group list-group-borderless mb-2">
                                        ...
                                        <li class="list-group-item px-0 d-flex justify-content-between my-2">
                                            <span class="h6 fw-light mb-0">Cart Subtotal</span>
                                    ...
                                    <form action="shopping_balance.php" method="post" id="shopping-balance-form">
                                        ...
                                        <button type="submit" name="cart_submit_order" class="btn btn-lg btn-success w-100" onclick="return confirm('Do You Really Want To Order Proposals From Your Shopping Balance.')">
                                            Place Order
                                        </button>
                                    </form>
                                    ...
                                    <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="paypal-form">
                                        ...
                                        <input type="hidden" name="business" value="sb-nnhbv16437012@business.example.com">
                                        ...
                                        <input type="hidden" name="item_name_1" value="I will Sketch logo design from A to Z: for an app designer">
                                        <input type="hidden" name="item_number_1" value="1">
                                        <input type="hidden" name="amount_1" value="520">
                                        <input type="hidden" name="quantity_1" value="1">


                                        <input type="hidden" name="item_name_2" value="I will Sketch logo design from A to Z: for an app designer">
                                    ...
                                    <form action="cart_charge.php" method="post" id="credit-card-form">
                                        ...
                                        <input type="hidden" name="amount" value="">
                                        <input type="submit" class="btn btn-lg img-fluid btn-success w-100 strip-submit" data-key="pk_test_51L0aZcCWHilK5BnHfZxMQvDox3IL5sxEdgDTk0HCMpTi8fpZ1oCirU5rubFihfXKwzE5lzfqUwDNxkkm5EY5LGgO008ZvMxeF4" value="Pay With Credit Card" data-amount="52000" data-currency="usd" data-emial="timenyindonkunu@gmail.com" data-name="creativehub.com" data-image="assets/images/favicon.ico" data-description="Cart Proposals Payment" data-allow-remember-me="false">
                            ...
                            <div class="col-md-6 col-xl-12">
                                <div class="card bg-blue p-3 position-relative overflow-hidden" style="background:url(assets/images/pattern/05.png) no-repeat center center; background-size:cover;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-white text-opacity-75">Here is the
                                            description of premium
                                            features which will allow users to get benefits and
                                            save a lot of money</p>
                                        <!-- Button -->
                                        <a href="#" class="btn btn-sm btn-warning mb-0">Purchase
                                            Premium</a>
                                    </div>
                                </div>
                            </div>
