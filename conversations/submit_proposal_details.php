<div class="modal-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bg-dark rounded-3 p-4 p-sm-5 position-relative">
                            ...
                            <!-- --- company message  -->
                            <p class="alert alert-success mb-0 text-opacity-50 small" role="alert">
                                WE HAVE YOUR BACK
                                <span class="text-danger fw-bold">*
                                </span> For added safety and your protection, keep payments and communications
                                within CreativeHub.
                                request <a href="http://localhost/CreativeHub/help-&-Support.php" class="alert-link" style="text-decoration: underline;">Learn more</a>
                            </p>

                            <!-- Title -->
                            <h5 class="mb-3 mt-4 text-white">Indicate the Specifics of your Offer</h5>
                            <!-- request description -->
                                ...
                                <div class="d-xl-flex justify-content-between align-items-center">
                                    ...
                                    <div class="hstack gap-2 mb-2 mb-xl-0">
                                        ...
                                        <div class="avatar flex-shrink-0">
                                            <img class="avatar-img rounded-circle" src="http://localhost/CreativeHub/user_images/07.jpg" alt="avatar">
                                        </div>
                                        <!-- Info -->
                                        <div id="request-description">
                                            <!-- Avatar -->
                                            <h6 class="card-title mb-0 badge badge bg-warning bg-opacity-10 text-warning">
                                                <small>Dennis Barrett</small>
                                            </h6>
                                            <h6 class="card-title mb-0">I Will Fix Html , Php , Laravel,
                                                Css,Javascript , Jquery Bugs</h6>
                                            <small> Hey can you make a complete platform exactly like netflix for
                                                me.</small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form id="proposal-details-form" class="row g-3 position-relative mt-4">
                                <!-- --- content message for request ------- -->
                                <div class="alert alert-info  d-flex justify-content-between align-items-center mt-2 mb-0 rounded-3 pe-2 my-4" role="alert">
                                    <div>
                                        <!-- Avatar -->
                                        <div class="avatar avatar-xs me-2">
                                            <img class="avatar-img rounded-circle" src="http://localhost/CreativeHub/user_images/03.jpg" alt="avatar">
                                        </div>
                                        <!-- Info -->
                                        Yes. I can make a complete platform exactly like netflix, and fix the bugs It
                                        will be cost a ($300)+
                                    </div>
                                </div>
                                ...
                                <div class="col-12 bg-dark-input">
                                    <label class="form-label text-white text-opacity-50">Additional Description
                                        :</label>
                                    <textarea name="description" class="form-control" rows="3" placeholder="" data-gramm="false" wt-ignore-input="true" require></textarea>
                                </div>

                                <!-- First name -->
                                <div class="col-md-6 bg-dark-input col-lg-12 col-xl-6 mb-2 mt-4">
                                    <label class="form-label text-white text-opacity-50">Total Offer Amount
                                        :</label>
                                    <input type="number" name="amount" class="form-control" id="firstName" min="5" placeholder="5 Minimum">
                                </div>

                                <!-- Partnership -->
                                <div class="col-md-6 bg-dark-input col-lg-12 col-xl-6 mb-2 mt-4">
                                    <label class="form-label text-white text-opacity-50"> Delivery Time : </label>
                                    <select class="form-select js-choice z-index-9" name="delivery_time">
                                        <option lass="bg-dark" value="1 Day"> 1 Day </option>
                                        <option lass="bg-dark" value="2 Days"> 2 Days </option>
                                        <option lass="bg-dark" value="3 Days"> 3 Days </option>
                                    </select>
                                </div>
    ...
    <div class="modal-footer ">
        <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal" data-bs-target="#send-offer-modal" data-bs-toggle="modal"><i class="bi bi-arrow-left ms-2"></i>Back</button>


        <button type="submit" class="btn btn-sm btn-warning">Submit Request <i class="bi bi-arrow-right ms-2"></i></button>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        $("#proposal-details-form").submit(function(event) {
            ...
            $.ajax({
                    method: "POST",
                    url: "http://localhost/CreativeHub/conversations/insert_offer.php",
