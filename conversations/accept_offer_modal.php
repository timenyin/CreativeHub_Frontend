        ...
        <div class="modal-content">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="">
                                                        ...
                                                        <div>
                                                            <span
                                                                class="badge bg-success bg-opacity-10 text-success rounded-0 px-2 py-2">Listing
                                                                Fee: <span class="fw-bolder">$20</span></span>
                                                            <span
                                                                class="badge bg-success bg-opacity-10 text-success rounded-0 px-2 py-2">Duration:
                                                                3 Days </span>



                                                            <div
                                                                class="alert alert-success alert-dismissible d-flex justify-content-between align-items-center fade show py-2 px-2 mb-2 rounded-0 mt-1 ">
                                                                <div>
                                                                    <span class="fw-bolder">Proposal Description:</span>
                                                                    I Will Fix Html , Php , Laravel, Css,Javascript ,
                                                                    Jquery Bugs
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <h5 class="card-title mt-1 mb-0 ">
                                                <small class="fw-bold">Proposal Amount:
                                                    ...
                                                    <span class="price text-success display-5 lead"> $300
                                                    </span>
                                                </small>

                                            </h5>
                                            <div class="alert alert-success alert-dismissible d-flex justify-content-between align-items-center fade show py-2 pe-2 mb-2"
                                                role="alert">
                                                <div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="payment_option" id="shopping-balance" checked>
                                                        ...
                                                        <div class="col-md-12 text-center text-md-start">
                                                            ...
                                                            <div class="card card-body border">
                                                                <div
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="payment_option" id="paypal">

                                                                    </div>
                                                                    <ul
                                                                        class="list-inline vstack gap-4 flex-wrap mt-1 ms-3">
                                                                        <!-- Item -->
                                                                        <li class="list-inline-item  me-0">
                                                                            <div
                                                                                ...
                                                                                <div class="col-lg-auto mt-4">
                                                                                    <span class="float-right mr-4">
                                                                                        <img class="checkout_payment_img"
                                                                                            src="http://localhost/CreativeHub/assets/images/element/paypalpay.svg"
                                                        ...
                                                        <div class="col-md-12 text-center text-md-start">
                                                            ...
                                                            <div class="card card-body border">
                                                                <div
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="payment_option" id="credit-card">
                                                                    </div>
                                                                    <ul
                                                                        class="list-inline vstack gap-4 flex-wrap mt-1 ms-3">
                                                                        <!-- Item -->
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="col-lg-auto mt-4">
                                                                                    <span class="float-right me-3">
                                                                                        <img src="http://localhost/CreativeHub/assets/images/element/creditCardPay.svg"
                                                                                            width="90" height="90"
            ...
            <div class="modal-footer">
                ...
                <form action="../shopping_balance.php" method="post" id="shopping-balance-form">
                    ...
                    <button type="submit" name="message_offer_submit_order" class="btn btn-sm btn-success "
                        onclick="return confirm('Do You Really Want to Order This Offer From Your Shopping Balance.')">
                        Place Order
                    </button>
                ...
                <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="paypal-form">
                    ...
                    <input type="hidden" name="cancel_return"
                        value="http://localhost/CreativeHub/conversations/insert_message.php?single_message_id=">
                    <input type="hidden" name="return"
                        value="http://localhost/CreativeHub/paypal_order.php?insert_message=1&message_offer_id=">

                    <input type="hidden" name="item_name"
                        value="I Will Fix Html , Php , Laravel, Css,Javascript , Jquery Bugs">
                ...
                <form action="accept_offer_charge.php" method="post" id="credit-card-form">
                    ...
                    <input type="hidden" name="amount" value="">
                    <input type="submit" class="btn btn-sm img-fluid btn-success w-100 strip-submit"
                        ...
                        data-amount="2000" data-currency="usd" data-email="creativehubmessage@gmail.com"
                        data-name="Creativehub" data-image="http://localhost/CreativeHub/assets/images/payment_icon.svg"
