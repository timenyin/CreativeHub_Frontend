<div class="modal fade" id="send-offer-modal">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                            ...
                            <div class="col-lg-12">
                                <div class="bg-dark rounded-3 p-4 p-sm-5 position-relative">
                                    ...
                                    <figure class="position-absolute top-0 start-50 translate-middle w-100 mt-n1">
                                        <svg enable-background="new 0 0 420.7 53.6" version="1.1"
                                            viewBox="0 0 420.7 53.6" xml:space="preserve"
                                    ...
                                    <figure class="w-100 position-absolute top-100 start-50 translate-middle">
                                        <svg enable-background="new 0 0 607.7 74.6" version="1.1"
                                            viewBox="0 0 607.7 74.6" xml:space="preserve"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path class="fill-dark"
                                            ...
                                            <div class="hstack gap-2 mb-2 mb-xl-0">
                                                ...
                                                <div class="avatar flex-shrink-0">
                                                    <img class="avatar-img rounded-circle"
                                                        src="http://localhost/CreativeHub/user_images/07.jpg"
                                                        alt="avatar">
                                                </div>
                                                <!-- Info -->
                                                <div id="request-description">
                                                    <!-- Avatar -->
                                                    <h6
                                                        class="card-title mb-0 badge badge bg-warning bg-opacity-10 text-warning">
                                                        <small>Dennis Barrett</small>
                                                    </h6>
                                                    <h6 class="card-title mb-0">I Will Fix Html , Php , Laravel,
                                                        Css,Javascript , Jquery Bugs</h6>
                                                    <small>Yes. I can make a complete platform exactly like netflix, and
                                                        fix the bugs It will be cost a ($300)+</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Title -->
                                    <h5 class="mt-3 text-white">Select Offers</h5>
                                    <div class="request-proposals-list">
                                        <!-- list of request -->

                                        <!-- list of request -->
                                        <div class="list-inline-item mb-1">
                                            <input type="radio" id="radio-1" class="btn-check" name="proposal_id"
                                                value="" required>
                                            <label
                                                class="btn btn-success-soft-check radio-custom-label radio-custom-label2"
                                                for="radio-1">
                                                <i class="bi bi-circle" style="font-size: 1.5rem;color: #0cbc87;"></i>
                                            </label>
                                            <div class="card card-x  card-body border">
                                                <div class="d-xl-flex  align-items-center">
                                                    ...
                                                    <div class="hstack gap-2 mb-2 mb-xl-0">
                                                        ...
                                                        <div class="avatar flex-shrink-0">
                                                            <img class="avatar-img rounded-circle"
                                                                src="http://localhost/CreativeHub/user_images/08.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <!-- Info -->
                                                        <div>
                                                            <h6
                                                                class="card-title mb-0 badge bg-success bg-opacity-10 text-success">
                                                                Dennis Barrett</h6> <br>
                                                            <small class="">I Will Do it by days from this post,logo
                                                                Design with PHP</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <!-- end of list of request -->
                                        <hr>

                                        <!-- list of request -->
                                        <div class="list-inline-item mb-1">
                                            <input type="radio" id="radio-2" class="btn-check" name="proposal_id"
                                                value="" required>
                                            <label
                                                class="btn btn-success-soft-check radio-custom-label radio-custom-label2"
                                                for="radio-2">
                                            ...
                                            <div class="card card-body card-x  border">
                                                <div class="d-xl-flex  align-items-center">
                                                    <!-- Avatar and info -->
                                                    <div class="hstack gap-2 mb-2 mb-xl-0">
                                                        <!-- Avatar -->
                                                        <div class="avatar flex-shrink-0">
                                                            <img class="avatar-img rounded-circle"
                                                                src="http://localhost/CreativeHub/user_images/03.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <!-- Info -->
                                                        <div>
                                                            <h6
                                                                class="card-title mb-0 badge bg-success bg-opacity-10 text-success">
                                                                Dennis Barrett</h6> <br>
                                                            <small class="">I'm available for this job. i will added
                                                                with dashboard plugins and social media
                                                                plugins</small>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <!-- list of request -->
                                        <div class="list-inline-item mb-1">
                                            <input type="radio" id="radio-3" class="btn-check" name="proposal_id"
                                                value="" required>
                                            <label
                                                class="btn btn-success-soft-check radio-custom-label radio-custom-label2"
                                                for="radio-3">
                                            ...
                                            <div class="card card-x  card-body border">
                                                <div class="d-xl-flex  align-items-center">
                                                    ...
                                                    <div class="hstack gap-2 mb-2 mb-xl-0">
                                                        ...
                                                        <div class="avatar flex-shrink-0">
                                                            <img class="avatar-img rounded-circle"
                                                                src="http://localhost/CreativeHub/user_images/10.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <!-- Info -->
                                                        <div>
                                                            <h6
                                                                class="card-title mb-0 badge bg-success bg-opacity-10 text-success">
                                                                James Cloner </h6> <br>
                                                            <small class="">Okay when day will need it to be ready I'm
                                                                available for this job. i will added
                                                                with dashboard plugins and social media
                                                                plugins</small>
                                                        </div>
                                                    </div>
            ...
            <div class="modal-footer ">
                ...
                <button type="button" id="submit-proposal" data-bs-toggle="modal" data-bs-dismiss="modal"
                    data-bs-target="#submit-proposal-details" class="btn btn-sm btn-warning">Next <i
...
$(document).ready(function() {
    ...
    $("#submit-proposal").click(function() {
        ...
        $.ajax({
                method: "POST",
                url: "http://localhost/CreativeHub/conversations/submit_proposal_details.php",
                data: {
...
<script>
// Keep track of the previously selected radio button
var prevSelectedRadio = null;

// Add click event listeners to radio buttons
document.querySelectorAll('input[name="proposal_id"]').forEach(function(radio) {
    radio.addEventListener('click', function() {
        // Reset the icon of the previously selected radio button
        if (prevSelectedRadio) {
            var prevLabel = document.querySelector('label[for="' + prevSelectedRadio.id + '"]');
            prevLabel.innerHTML =
                '<i class="bi bi-circle" style="font-size: 1.5rem;color: #0cbc87;"></i>';
        }
        // Get the corresponding label
        var label = document.querySelector('label[for="' + this.id + '"]');
        // Change the icon inside the label with a smooth transition
        label.innerHTML =
            '<i class="bi bi-check2-circle" style="font-size: 1.5rem;margin-right: 10px;color: #0cbc87;"></i>';
