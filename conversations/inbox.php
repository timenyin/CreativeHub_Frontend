...
Page Banner END -->
        ...
        <section class="pt-0 pt-lg-5">
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <h2 class="mb-0 text-success">Manger your Conversation </h2>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="pt-0">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        <!-- conversation table  -->
                        <div class="table-responsive border-0 mt-1">
                            <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center position-relative">
                                                ...
                                                <div class="avatar avatar-md mb-2 mb-md-0">
                                                    <img src="../user_images/01.jpg" class="rounded" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                                    <h6 class="mb-0"><a href="http://localhost/CreativeHub/user.php" class="stretched-link">Lori
                                                            Stevens</a></h6>
                                        ...
                                        <!-- Table data -->
                                        <td><a href="insert_message.php?single_message_id=" class=" h6 text-secondary hover_conversation_msg">Own your code and
                                                the rest will follow: Read
                                                our free guide
                                                to full-service ownership. ads via Carbon</a></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="dropdown flex-shrink-0">
                                                <a href="#" class="text-primary-hover text-success p-0 mb-0" id="cardShareAction2" data-bs-toggle="dropdown" aria-expanded="false">
                                                    <i class="bi bi-three-dots"></i>
                                                </a>
                                                <!-- Card share action dropdown menu -->
                                                <ul class="dropdown-menu dropdown-menu-end min-w-auto" aria-labelledby="cardShareAction2">
                                                    <li><a href="insert_message.php?single_message_id=" class="dropdown-item btn-success-soft mb-1" href="http://localhost/CreativeHub/proposal.php"><i class="bi bi-eye-fill"></i> View
                                                            Message</a></li>

                                                    <li><a class="dropdown-item btn-danger-soft" href="#"><i class="bi bi-recycle"></i> Delete Message</a></li>
                                                </ul>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center position-relative">
                                                <!-- Image -->
                                                <div class="avatar avatar-md mb-2 mb-md-0">
                                                    <img src="../user_images/03.jpg" class="rounded" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                                    <h6 class="mb-0"><a href="http://localhost/CreativeHub/user.php" class="stretched-link">Bennet
                                                            Rogues</a></h6>
                                        ...
                                        <!-- Table data -->
                                        <td><a href="insert_message.php?single_message_id=" class=" h6 text-secondary hover_conversation_msg">Whether the dropdown
                                                should appear above (top) or below (bottom) the input. Default value is
                                                auto</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center position-relative">
                                                <!-- Image -->
                                                <div class="avatar avatar-md mb-2 mb-md-0">
                                                    <img src="../user_images/06.jpg" class="rounded" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                                    <h6 class="mb-0"><a href="http://localhost/CreativeHub/user.php" class="stretched-link">Matt Law</a>
                                                    </h6>
